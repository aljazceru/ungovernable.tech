...
- [moseszhu999/ynet](https://github.com/moseszhu999/ynet) - yNet — Decentralized compute network with OpenAI-compatible inference API
- [theblitlabs/parity-client](https://github.com/theblitlabs/parity-client) - Parity Protocol client — decentralized compute network for distributed task execution with blockchain-based incentives (Go)
