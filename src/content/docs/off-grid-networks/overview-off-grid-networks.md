---
title: "Overview - Off-Grid Networks"
tags:
  - "off-grid"
  - "mesh-network"
  - "meshnet"
...
- [Overview - Encrypted Messaging](/encrypted-messaging/overview-encrypted-messaging) — Briar, SimpleX, and offline-first protocols
- [Overview - Mix Networks](/mix-networks/overview-mix-networks) — anonymity overlays applicable to mesh
